fetchData = function(){
    ...
    fetch('https://api.coingecko.com/api/v3/simple/price?ids=matic-network%2Cbitcoin%2Cethereum%2Cdogecoin%2Cbinancecoin%2Ctether%2Czelcash%2Ctron%2Clitecoin%2Csolana&vs_currencies=try', {
      method: 'GET', // or 'PUT'
      headers: {
...
postResults = function(prices){
    document.getElementById("btc-price-api").innerHTML = prices[0] + "TL";
    document.getElementById("doge-price-api").innerHTML = prices[1] + "TL";
    document.getElementById("eth-price-api").innerHTML = prices[2] + "TL";
	document.getElementById("bnb-price-api").innerHTML = prices[3] + "TL";
	document.getElementById("matic-price-api").innerHTML = prices[4] + "TL";
	document.getElementById("sol-price-api").innerHTML = prices[5] + "TL";
	document.getElementById("trx-price-api").innerHTML = prices[6] + "TL";
	document.getElementById("ltc-price-api").innerHTML = prices[7] + "TL";
}
